...
LINT=false
LINT_CHECKS=""
SUPPORTED_LANGUAGES=("go" "ruby" "csharp" "java" "python" "objc" "gogo" "php" "node" "web" "web-client" "cpp" "descriptor_set" "scala")
EXTRA_INCLUDES=""
OUT_DIR=""
GO_SOURCE_RELATIVE=""
GO_PACKAGE_MAP=""
...
:$OUT_DIR"
    ...
    "node")
        ...
        ;;
    "web-client")
        GEN_STRING="--ts_out=service=grpc-web:$OUT_DIR --js_out=import_style=commonjs,binary:$OUT_DIR --plugin=protoc-gen-ts=`which protoc-gen-ts`"
        ;;
    "web")
